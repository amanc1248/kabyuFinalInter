          ...
          GestureDetector(
              onTap: () {
                ...
                if (_form.currentState.validate()) {
                  ...
                  theProvider.userDetails.clear();
                  theProvider.userDetails.add(
                      User(userEmail: _email.text, userPassword: _pass.text));
                  print("Email: " +
                      theProvider.userDetails[0].userEmail +
                      "\n" +
                      "Password: " +
                      theProvider.userDetails[0].userPassword);
